...
import { INITIAL_LIVES, SCORE_INCREMENT, SPAWN_INTERVAL, SEA_HEIGHT, TEXT_FONT, TEXT_COLOR, LIVES_TEXT_X, LIVES_TEXT_Y, SCORE_TEXT_X, SCORE_TEXT_Y, PLANE_WIDTH, PLANE_HEIGHT, PLANE_START_X, PLANE_SPEED, BOAT_WIDTH, BOAT_HEIGHT, PARACHUTIST_WIDTH, PARACHUTIST_HEIGHT, } from "./constants.js";
...
export class GameController {
    ...
    update() {
        if (!this.gameEnded) {
            ...
            this.parachutists.forEach((parachutist, index) => {
                ...
                if (parachutist.x < this.boat.x + BOAT_WIDTH &&
    ...
    draw() {
        ...
        this.ctx.drawImage(seaImage, 0, this.canvas.height - SEA_HEIGHT, this.canvas.width, SEA_HEIGHT);
        // Draw game objects
        this.boat.draw();
        ...
        // Draw airplane
        this.ctx.drawImage(airplaneImage, this.planeX, PLANE_START_X, PLANE_WIDTH, PLANE_HEIGHT);
    }
